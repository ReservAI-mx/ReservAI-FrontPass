...
router.get('/admin/jobs', (req, res) => res.sendFile(path.resolve(__dirname + "/../views/jobs.html")));
router.get('/admin/products', (req, res) => res.sendFile(path.resolve(__dirname + "/../views/products.html")));
